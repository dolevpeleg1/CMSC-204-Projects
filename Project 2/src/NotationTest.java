...
public class NotationTest {
	...
	@Test
	public void testComplexConvertInfixToPostfix() { // I added a try-catch block because convertInfixToPostfix throws an exception as one of the project requirements - Dolev
		try
		{
	...
	@Test
	public void testIntermediateConvertInfixToPostfix() { // I added a try-catch block because convertInfixToPostfix throws an exception as one of the project requirements - Dolev
		try
		{
	...
	@Test
	public void testEasyConvertInfixToPostfix() { // I added a try-catch block because convertInfixToPostfix throws an exception as one of the project requirements - Dolev
		try
		{
	...
	@Test
	public void testComplexConvertPostfixToInfix() { // I added a try-catch block because convertPostfixToInfix throws an exception as one of the project requirements - Dolev
		try
		{
	...
	@Test
	public void testIntermediateConvertPostfixToInfix() { // I added a try-catch block because convertPostfixToInfix throws an exception as one of the project requirements - Dolev
		try
		{
	...
	@Test
	public void testEasyConvertPostfixToInfix() { // I added a try-catch block because convertPostfixToInfix throws an exception as one of the project requirements - Dolev
		try
		{
	...
	@Test
	public void testComplexEvaluatePostfixExpression() { // I added a try-catch block because evaluatePostfixExpression throws an exception as one of the project requirements - Dolev
		try
		{
	...
	@Test
	public void testIntermediateEvaluatePostfixExpression() { // I added a try-catch block because evaluatePostfixExpression throws an exception as one of the project requirements - Dolev
		try
		{
	...
	@Test
	public void testEasyEvaluatePostfixExpression() { // I added a try-catch block because evaluatePostfixExpression throws an exception as one of the project requirements - Dolev
		try
		{
